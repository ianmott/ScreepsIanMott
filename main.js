...
module.exports.loop = function() {
    ...
    Types[0] = new Array(3); Types[0][0] = 'harvester'; Types[0][1] = 3; Types[0][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'harvester').length;
    ...
    Types[3] = new Array(3); Types[3][0] = 'repairer';  Types[3][1] = 4; Types[3][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'repairer').length;
