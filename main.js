...
module.exports.loop = function() {
    ...
    Types[2] = new Array(3); Types[2][0] = 'upgrader';  Types[2][1] = 8; Types[2][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'upgrader').length;
    ...
    if (TickCounter%100 == 0){ console.log('h#/X='+Types[0][2]+'/'+Types[0][1]+' b#/X='+Types[1][2]+'/'+Types[1][1]+' u#/X='+Types[2][2]+'/'+Types[2][1]+' r#/X='+Types[3][2]+'/'+Types[3][1]+' g#/X='+Types[4][2]+'/'+Types[4][1]);
    }
    ...
    if (TickCounter == 0) {TickCounter = 10000;} else {TickCounter--;}
};
