...
module.exports.loop = function() {
    ...
    Types[1] = new Array(3); Types[1][0] = 'builder';   Types[1][1] = 2; Types[1][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'builder').length;
    Types[2] = new Array(3); Types[2][0] = 'upgrader';  Types[2][1] = 5; Types[2][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'upgrader').length;
    Types[3] = new Array(3); Types[3][0] = 'repairer';  Types[3][1] = 5; Types[3][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'repairer').length;
    Types[4] = new Array(3); Types[4][0] = 'guard';  Types[4][1] = 1; Types[4][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'guard').length;
