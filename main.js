...
module.exports.loop = function() {
	...
	var TWeights = new Array(NumofTypes);
	   //      Harvester            Guard         Upgrader         repairer        
	    TWeights[0] = 0; TWeights[1] = 1; TWeights[2] = 4; TWeights[3] = 5;
	   //      builder       rangedguard        tharvester      atcontroller
	    TWeights[4] = 6; TWeights[5] = 3; TWeights[6] = 2; TWeights[7] = 7;
	var toggle = false;
    var Types = new Array(NumofTypes);           // Type Name     Type Min       Type Current
        // Parts                                                        Cost
    Types[TWeights[0]] = new Array(numofFields); Types[TWeights[0]][0] = 'harvester'; Types[TWeights[0]][1] = 3; Types[TWeights[0]][4] = 1199; Types[TWeights[0]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'harvester').length;   
        Types[TWeights[0]][3] = [WORK,WORK,CARRY,CARRY,MOVE,CARRY,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE];  
    ...
    Types[TWeights[3]] = new Array(numofFields); Types[TWeights[3]][0] = 'repairer';  Types[TWeights[3]][1] = 3;  Types[TWeights[3]][4] = 1199; Types[TWeights[3]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'repairer').length;    
        Types[TWeights[3]][3] = [CARRY,WORK,WORK,WORK,CARRY,CARRY,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE]; 
    Types[TWeights[4]] = new Array(numofFields); Types[TWeights[4]][0] = 'builder';   Types[TWeights[4]][1] = 1;  Types[TWeights[4]][4] = 1199; Types[TWeights[4]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'builder').length;     
