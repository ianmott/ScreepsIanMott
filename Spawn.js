...
var Spawn = {
    ...
    run: function(RoomName) {
        ...
        Types[TWeights[3]] = new Array(numofFields); Types[TWeights[3]][0] = 'repairer';     Types[TWeights[3]][1] = 2;  Types[TWeights[3]][4] = 999;  Types[TWeights[3]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'repairer' && creep.memory.roomName == RoomName).length;     Types[TWeights[3]][3] = [WORK,WORK,CARRY,CARRY,CARRY,CARRY,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE];
