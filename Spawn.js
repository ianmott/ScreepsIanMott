...
var Spawn = {
    ...
    run: function(RoomName) {
        ...
        Types[TWeights[6]] = new Array(numofFields); Types[TWeights[6]][0] = 'tharvester';   Types[TWeights[6]][1] = 2;  Types[TWeights[6]][4] = 999; Types[TWeights[6]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'tharvester' && creep.memory.roomName == RoomName).length;   Types[TWeights[6]][3] = [WORK,WORK,CARRY,CARRY,CARRY,CARRY,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE];
