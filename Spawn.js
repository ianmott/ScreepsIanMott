...
var Spawn = {
    ...
    run: function(RoomName) {
        ...
        Types[TWeights[4]] = new Array(numofFields); Types[TWeights[4]][0] = 'builder';      Types[TWeights[4]][1] = 1;  Types[TWeights[4]][4] = 949;  Types[TWeights[4]][2] = _.filter(Game.creeps, (creep) => creep.memory.role == 'builder' && creep.memory.roomName == RoomName).length;      Types[TWeights[4]][3] = [WORK,WORK,CARRY,CARRY,CARRY,CARRY,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE]; 
